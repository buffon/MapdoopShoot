...
public class SingleWordCount {
    public static class SingleWordCountMapper extends Mapper<Object, Text, Text, IntWritable> {
    ...
    public static class SingleWordCountReducer extends Reducer<Text,IntWritable,Text,IntWritable> {
